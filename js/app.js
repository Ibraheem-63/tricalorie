...
class calorieTracker {
  ...
  _displayCaloriesRemain() {
    ...
    if (remain <= 0) {
      caloriesRemainEl.parentElement.classList.remove("bg-light");
      caloriesRemainEl.parentElement.classList.add("bg-danger");
      progressEl.classList.add("bg-danger");
      progressEl.classList.remove("bg-success");
    } else {
      caloriesRemainEl.parentElement.classList.remove("bg-danger");
      caloriesRemainEl.parentElement.classList.add("bg-light");
  ...
  _displayCaloriesProgress() {
    const progressEl = document.getElementById("calorie-progress");
    const percentages = (this.totalCalories / this._calorieLimit) * 100;
...
class App {
  ...
  _reset() {
    if (confirm("Are you sure you squidworm")) {
      this._tracker.reset();
...
// const run = new Workout("Morning", 300);
